...
// Note(dahai): this file provide basic utf8 utilities from icu.
// If you need more features, try //third_party/icu.

#ifndef BASE_ICU_UTF_H_
#define BASE_ICU_UTF_H_
